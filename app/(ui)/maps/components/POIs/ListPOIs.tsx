import { MapWithPOIsDTO } from "../../../../api/maps/types";
import ButtonDeleteAllPOIs from "./ButtonDeleteAllPOIs";
    ...
    return(
        <div className="relative w-full h-full border flex flex-col">
          ...
          <div className="h-full w-full p-6 pt-10 overflow-y-auto custom-scrollbar">
              <ol className="flex flex-col gap-4 overflow-y-scroll font-sans">
                {map.pois.length > 0 ? (
                  map.pois.map((pois) => (
