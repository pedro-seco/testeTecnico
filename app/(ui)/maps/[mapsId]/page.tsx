import { searchMapWithPOIs } from "@/app/api/maps/[mapsId]/service";
import NavBar from "@/app/(ui)/commonComponents/NavBar";
import { notFound } from "next/navigation";
import { MapWindow } from "@/app/(ui)/maps/components/maps/MapWindow";
